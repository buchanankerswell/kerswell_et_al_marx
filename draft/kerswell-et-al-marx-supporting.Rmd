...
walk(
  ...
  ~{
#    cat('\n\n\\blandscape\n\n')
#    cat('![Marker classification for model ', .x, '. Refer to the main text for explanation of panels and colors.](assets/figs/class_comp/', .x, '-class-comp.png "Marker classification for model ', .x, '")', '', sep = '')
#    cat('\n\n\\elandscape\n\n')
    cat('\n\n\\blandscape\n\n')
    cat('![PT distribution of recovered markers from model ', .x, '. Refer to the main text for explanation of panels and colors.](assets/figs/marx_comp/', .x, '-marx-comp.png "PT distribution of recovered markers from model ', .x, '")', '', sep = '')
    cat('\n\n\\elandscape\n\n')
  }
)
```
